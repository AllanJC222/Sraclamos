    ...
    <style>
        ...
        * {
        ...
        .main-navbar {
            ...
            padding: 0.5rem 1rem;
            background-color: #1e4d7cb7;
            /* Color de fondo oscuro, similar a Bootstrap */
        }
...
<body>
    ...
    <nav class="main-navbar">
        <div class="container-fluid">
            ...
            <ul class="nav-links">
                <a class="brand-link" href="#">Mi Aplicación</a>
    ...
    <main>
        <section class="container">
            ...
            <aside class="card">
                ...
                <form onsubmit="event.preventDefault(); alert('Intento de login (implementa la lógica en el backend)')">
                    <div class="field">
                        <input id="email" name="email" type="email" placeholder="Usuario" required />
                    </div>
                    <div class="field">
                    ...
                    <div class="small">Ingresar como Abonado</div>
                </form>
            </aside>
        </section>
    </main>
